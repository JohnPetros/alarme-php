...
<html lang="pt-br">
  ...
  <body>
    ...
    <form class="container" action="alarm.php" method="post">
      ...
      <div>
        <label for="Dom" class="week-day checked"
          ><input type="checkbox" id="Dom" name="Dom" value="Dom" />do</label
        >
        <label for="Seg" class="week-day checked"
          ><input type="checkbox" id="Seg" name="Seg" value="Seg" />se</label
        >
        <label for="Ter" class="week-day checked"
          ><input type="checkbox" id="Ter" name="Ter" value="Ter" />te</label
        >
        <label for="Qua" class="week-day checked"
          ><input type="checkbox" id="Qua" name="Qua" value="Qua" />qu</label
        >
        <label for="Qui" class="week-day checked"
          ><input type="checkbox" id="Qui" name="Qui" value="Qui" />qu</label
        >
        <label for="Sex" class="week-day checked"
          ><input type="checkbox" id="Sex" name="Sex" value="Sex" />se</label
        >
        <label for="Sáb" class="week-day checked"
          ><input type="checkbox" id="Sáb" name="Sáb" value="Sáb" />sá</label
        >
      </div>
